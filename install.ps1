...
# Usage:
#   Install:   irm https://raw.githubusercontent.com/thierryteisseire/epsimo-agent/main/install.ps1 | iex
#   Uninstall: & { irm https://raw.githubusercontent.com/thierryteisseire/epsimo-agent/main/install.ps1 -OutFile $env:TEMP\ep.ps1; & $env:TEMP\ep.ps1 -Uninstall }
...
$Repo      = "thierryteisseire/epsimo-agent"
